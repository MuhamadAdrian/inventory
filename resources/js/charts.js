...
// Wrap chart instantiation in a DOMContentLoaded listener
// or a function that gets called after Chart is globally available.
// This ensures the canvas elements exist and Chart.js is loaded.
document.addEventListener('DOMContentLoaded', () => {
    // Check if Chart is defined before trying to use it
    if (typeof Chart === 'undefined') {
        console.error('Chart.js is not defined. Ensure it is imported and exposed globally in app.js.');
        return;
    }
            ...
            datasets: [
                {
                    ...
                    // highlightFill: 'rgba(220, 220, 220, 0.75)', // These options are for Chart.js v1, remove for v2+
