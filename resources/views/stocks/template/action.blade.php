<div class="d-flex">
  ...
  <form action="{{ route('stock-transfers.cancel_transfer', $request->id) }}" method='POST' onsubmit='return confirm("Apakah Anda yakin ingin menghapus permintaan transfer ini?");' style='display:inline-block;'>
      @csrf
      @method('put')
